...
var lychee = {
	...
	init: function() {
		...
		lychee.api(params, function(data) {
			...
			// No configuration
			if (data==="Achtung: Nicht konfiguriert!") {
				lychee.header.hide();
				lychee.content.hide();
	...
	api: function(params, callback, loading) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (typeof data==="string"&&data.substring(0, 7)==="Fehler: ") {
			...
			error: function(jqXHR, textStatus, errorThrown) {
				...
				lychee.error("Serverfehler oder API nicht gefunden, du Labbeduddel!.", params, errorThrown);
				upload.close(true);
