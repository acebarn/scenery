...
$(document).ready(function(){
	...
	$("#button_share_album").on(event_name, function(e) {
		...
		else modal.show("Album teilen", "Alle Fotos in diesem Album werden öffentlich und daher für jeden x-beliebigen sichtbar sein. Bereits existierende öffentliche Fotos werden die gleiche Sichtbarkeit wie dieses Album besitzen. Bist du sicher, dass du dieses Album teilen willst? <input class='text' type='password' placeholder='Passwort (optional)' value=''>", [["Album teilen", function() { album.setPublic(album.getID(), e) }], ["Abbrechen", function() {}]]);
	});
